...
function platformBackOrClose() {
  if (globalThis.webOS && typeof globalThis.webOS.platformBack === "function") {
    try {
      globalThis.webOS.platformBack();
      return;
    } catch (error) {
      console.warn("webOS.platformBack failed, falling back to close()", error);
    }
  }
