  ...
  async mount() {
    ...
    this.container.innerHTML = `
      <div class="profile-screen">
        ...
        <h1 class="profile-title">${I18n.t("profile_selection.title")}</h1>
        <p class="profile-subtitle">${I18n.t("profile_selection.subtitle")}</p>

        <div class="profile-grid" id="profileGrid"></div>

        <p class="profile-hint">${I18n.t("profile_selection.hint")}</p>
      </div>
    `;
    ...
    this.profiles.forEach((profile) => {
      ...
      card.innerHTML = `
        ...
        ${profile.isPrimary ? `<div class="profile-badge">${I18n.t("profile_selection.primary")}</div>` : ""}
      `;
